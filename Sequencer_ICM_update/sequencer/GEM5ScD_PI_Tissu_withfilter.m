...
P.frequency     = 2.25;%2/3*Trans.frequency; % in MHz

% For PI/SHI
%--- Tx strategy for PI (number of steering will be half of P.nbangles )
P.nbAngles      = 16;  % Steering angles for PW in Tx [deg]
...
P.Saturation    = 20;      % Saturation Display
P.NframeDisplay = 5;      % P.nbAcq;       % NbFrameForDisplay
